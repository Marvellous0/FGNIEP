                ...
                <div className="h-[100%] md:mx-0 md:my-auto min-w-[300px] w-full flex">
                    ...
                    <div className='bg-[white] h-full w-[20%] min-w-[200px] rounded-l-2xl shadow-sm hidden md:block p-5'>
                        <div className='flex items-center gap-2 mb-2'>
                            <img src={userImg} alt="userImage" className="h-[20%] w-[25%] rounded-full" />
                            <div>
                                <h6>Marvellous</h6>
                        ...
                        <h3 className='opacity-[0.7] mt-5'>MENU</h3>
                        <div className='mt-4 flex flex-col gap-3'>
                            {
                                navOptions.map((n, index) =>
                                    // n.isActive &&
                                    <div key={index} className={`flex items-center px-3 text-[15px] hover:opacity-[49%] ${activeSideOption == n.action ? `rounded-md h-[10%] w-[80%] text-[#50c7a2] bg-[#c7ede1] hover:opacity-[100%] items-center` : ""}`} onClick={(e) => { changeActiveSideOption(n.action) }}>
                                        <n.icon size={20} />
                                        <span className="tracking-[0.07em] p-3 cursor-pointer transition-all duration-300 whitespace-nowrap">{n.displayText}</span>
                                    </div>
                                )
                            }
                        </div>
                    ...
                    {/* topNav */}
                    <div className='border-[brown] border-2 w-[80%] h-[80px]'>
                    </div>
                </div>
            </div>
        </>
